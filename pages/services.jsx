		...
		<div className="min-h-screen my-16 max-w-7xl m-auto md:px-8 px-5 leading-7">
			...
			<div className="mt-20 mb-14 flex space-x-8 items-center">
				...
				<div className="flex-none w-4/12 lg:block hidden">
					<img className="rounded-3xl" src="ManPhone.png" alt="Man on phone" />
				</div>
			</div>
							...
							>
								<div className="space-y-3">
									...
									<ul className="list-disc list-outside pl-4 font-light space-y-2">
										...
										<li>
											You can use the technology you feel most comfortable with.
										</li>
									</ul>
								</div>
								<div className="space-y-3">
									...
									<ul className="list-disc list-outside pl-4 font-light space-y-2">
										<li>
											Will you get more from the session if you are seen by the
											therapist.
										</li>
										<li>It is a lot easier to misinterpret messages.</li>
										<li>
											Do you have a safe space to have a session for 50 minutes.
										</li>
										<li>
										...
										<li>
											...
											misunderstandings, or help you to feel focused and safer.
										</li>
							...
							>
								<div className="space-y-1">
									...
									<p className="pl-3 font-light">
										...
										overhear you. Maybe having headphones in the laptop/computer
										will make you feel better about not having what the
										therapist says overheard.
									</p>
								</div>
								<div className="space-y-1">
									<p className="font-semibold">Reduce Interruptions</p>
									<p className="pl-3 font-light">
										Locking doors/windows can ensure you are not interrupted and
										it is better to have phones on silent or well out of sight
										from yourself to prevent being distracted by messages from
										social media if you are not using them for the session.
									</p>
								</div>
								<div className="space-y-1">
									...
									<p className="pl-3 font-light">
										...
										room to remind any family member or roommate that you cannot
										be disturbed for a hour.
									</p>
								</div>
								<div className="space-y-1">
									...
									<p className="pl-3 font-light">
										...
										confidence in the security of inviting someone in your home
										using the webcam.
									</p>
								</div>
							</motion.div>
