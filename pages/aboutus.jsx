		...
		<div className="min-h-screen my-16 max-w-7xl m-auto md:px-8 px-5">
			...
			<div>
				<AboutPersonLong
					...
					title="Qualified Counsellor and Pschotherapist"
					...
					b2="I understand that counselling is a personal experience that needs to be tailored to my client. I feel the autonomy of the client should be respected at all times, as they are the most qualified person to know what they want from the counselling experience. I use my expertise to guide clients through a journey of exploration to know themselves better and achieve their desired goals. I work in the modality of person centred/ humanistic approach, although I draw upon other modalities depending on what is appropriate for each client."
					training="I am trained in counselling/psychotherapy (L5), with experience in domestic abuse, sexual violence, addicition and suicide awareness. I am also able to manage any of following issues;"
					addTraining={[
						'Common life issues',
						'Depression',
						'Anxiety',
					...
					f1="I am DASH trained to level 3 standard, trained in Mental health first aid as well as being a member of the BACP and WAC. I currently work as a learning support assistant for Adult Education and will be training as a tutor for level 2 counselling."
				...
				<AboutPersonLong
					...
					training="I have trained in domestic abuse and sexual violence (L1 & 2) and suicide awareness. Most of my experience is in bereavement/ grief/ loss and addiction, as I currently work with Cruse Bereavement and We are with You on a voluntary basis. I am also comfortable working with the following;"
					addTraining={[
						'Common life issues',
						'Depression',
						'Anxiety',
